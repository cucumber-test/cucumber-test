...
const browserTags = ['@__chrome', '@__safari', '@__firefox', '@__microsoftedge', '@__internetexplorer'];
const nonBrowserTags = ['@__non_chrome', '@__non_safari', '@__non_firefox', '@__non_microsoftedge', '@__non_internetexplorer'];
const mobileTags = ['@__android', '@__mobile', '@__ios'];
const nonMobileTags = ['@__non_android', '@__non_mobile', '@__non_ios'];
let _browserName;
