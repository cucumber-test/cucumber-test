...
if (program.config) {
    ...
    config = require(cpath)({ webdriverio: webdriverio, faker: faker, chance: chance, request: request });
}
...
if (program.specs) {
    var path = specs[0].replace('/**/*.feature', '');
    var files = compiler.traverseFileSystem(path);
...
var options = { services: [] }; // services: ['firefox-profile'],
var base = config.base || {};
var browsers = config.browsers || {};
var remoteConfig = {};

var browser = base.browser || 'chrome';
var timeout = base.timeout || 20000;
var retry = base.retry || 3;
