...
var _switchToWindow = require('../support/action2/switchToWindow');

var _switchToWindow2 = _interopRequireDefault(_switchToWindow);
...
(0, _cucumber.defineSupportCode)(function (_ref) {
    ...
    When(/^I switch to Main Window$/, _switchToWindow2.default);
});