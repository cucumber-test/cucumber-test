...
var _clickAppearElement = require('../support/action2/clickAppearElement');

var _clickAppearElement2 = _interopRequireDefault(_clickAppearElement);
...
var _deleteAllCookies = require('../support/action2/deleteAllCookies');

var _deleteAllCookies2 = _interopRequireDefault(_deleteAllCookies);

var _typeInputField = require('../support/action2/typeInputField');

var _typeInputField2 = _interopRequireDefault(_typeInputField);

var _dismissAlert = require('../support/action2/dismissAlert');

var _dismissAlert2 = _interopRequireDefault(_dismissAlert);
...
(0, _cucumber.defineSupportCode)(({ When }) => {
    ...
    When(/^I (click|doubleclick) on appearing (link|button|element) "([^"]*)?"$/, _clickAppearElement2.default);

    When(/^I (add|set) "([^"]*)?" to the inputfield "([^"]*)?"$/, _setInputField2.default);

    When(/^I type "([^"]*)?" to the inputfield "([^"]*)?"$/, _typeInputField2.default);
    ...
    When(/^I delete all cookies$/, _deleteAllCookies2.default);

    When(/^I press "([^"]*)?" to the inputfield "([^"]*)?"$/, _pressButton2.default);
    ...
    When(/^I dismiss Alert$/, _dismissAlert2.default);
});