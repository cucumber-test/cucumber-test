...
module.exports = function () {
    ...
    var config = require(global.browser.options.cpath)({ webdriverio: webdriverio, faker: faker, chance: chance, request: request });
    global.tags = config.tags || {};
    global.vars = config.vars || {};

    var _global$browser$optio = global.browser.options,
        vars = _global$browser$optio.vars,
        desiredCapabilities = _global$browser$optio.desiredCapabilities;
