...
module.exports = function () {
    ...
    browser.addCommand('setValueSafe', function (selector, text) {
         ...
         */
        getActualText = function getActualText(elementId) {
         ...
         */
        setChar = function setChar(elementId, text, i) {
            ...
            var inputPause = browser.options.base.inputPause || 500;
            try {
                browser.waitUntil(function () {
                    return getActualText(elementId) == expectedText;
                }, inputPause, "failed", 16);
            } catch (e) {
        ...
        browser.waitUntil(function () {
            return getActualText(elementId) == '';
        });
